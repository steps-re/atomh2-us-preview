...
`us_screen.json` is produced by an internal build step that pulls Alaska Power
Cost Equalization delivered-diesel invoices, the FCC Antenna Structure
Registration dump and NASA POWER climatology. Copy the refreshed JSON here and
re-run `build_page.py` to update the page.
